...
<body class="bg-gray-100">
    <div class="container mx-auto py-8 mt-12">
        ...
        <form id="lotteryForm" method="POST" action="{{ route('ticket.buy') }}"
            class="max-w-xl mx-auto p-6 bg-white shadow-md rounded">
            @csrf
            ...
            <div id="numbers" class="grid grid-cols-6 gap-4 justify-center mb-4">
                @for ($i = 1; $i <= 30; $i++)
                    <div class="number-button border-2 border-gray-300" data-number="{{ $i }}" 
                         title="Seleccionar número">{{ $i }}</div>
                @endfor
            </div>
            ...
            <label class="block mt-2">
                <input type="checkbox" name="category" id="category" value="1" class="mt-2" 
                       title="Selecciona esta opción para aumentar tus probabilidades de ganar" />
            ...
            <div class="message mt-4">
                <p>Para participar en el sorteo de
                    ...
                    billetes antes de las 23:59
                    horas de ese mismo día. Todas
                    las compras efectuadas dentro
                    de este plazo serán incluidas
